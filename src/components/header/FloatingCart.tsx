...
export default function FloatingCart() {
  ...
  return (
    ...
    >
      {CartQuantity > 0 && (
        <Flex borderRadius={"lg"} position={'fixed'} right={10} bottom={10}>
          <Link fontSize={28} onClick={onToggle} position="relative" color="balck" bgColor={'gray.200'}>
            Cart Items <IoBagOutline />
            <Text
              color="white"
              position="absolute"
              top={4}
